						...
						$(function() {
							$("#export").click(function(){
								var url = '<?php echo base_url();?>index.php/report/performance_value_report_ntspc/';
							...
							<div class="top-br">
								<div style="width:50%; float:left;">
									<span style="padding:15px;font-size:12px;font-family:calibri;color:#666"><a style="text-decoration:none;color:#666; padding-right:10px;" href="<?php echo base_url();?>index.php/">Home</a> <i style="padding-right:10px;" class="fa fa-angle-double-right"></i> <strong>BA Performance by Value (NOT SPECIFIC PRODUCTS)</strong></span>
								</div>
							</div>
						</div>
						<div class="body" style="background-color:#f1f1f1;padding-bottom:20px;">
							...
							<div style="margin-left:10px;margin-top:20px;margin-bottom:60px;background-color:transparent;padding:0px 20px;">
								<h2 style="color:#666;margin-left:10px;margin-bottom:0px;text-align:center;"><i class="fa fa-line-chart" style=""></i><i class="fa fa-close" style="margin-right:5px;font-size:12px;margin-left:-10px;margin-top:-4px;color:#fb654e;"></i>BA Performance by Value (NOT SPECIFIC PRODUCTS)</h2>
									<p style="font-size:12px;color:#666;margin-left:10px;text-align:center;width:530px;margin:auto;margin-top:20px;">Module BA Performance by Value (Reporting) merupakan salah satu module reporting, digunakan untuk mencetak dan mengeksport laporan performance dari BA dalam bentuk Currency / Nominal yang terjual dengan kriteria tertentu.</p>
								...
								<div id="body">
									<?php 
										...
										$phpgrid->set_caption("<h4 style='color:#444;'><i class='fa fa-th-large' style='margin-right:5px;'></i>Pivot Table (BA Performance By Value)</h4>");
