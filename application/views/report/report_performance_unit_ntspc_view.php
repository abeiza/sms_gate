						...
						$(function() {
							$("#export").click(function(){
								var url = '<?php echo base_url();?>index.php/report/performance_qty_report_ntspc/';
						...
						<div class="top-br">
								<div style="width:50%; float:left;">
									<span style="padding:15px;font-size:12px;font-family:calibri;color:#666"><a style="text-decoration:none;color:#666; padding-right:10px;" href="<?php echo base_url();?>index.php/">Home</a> <i style="padding-right:10px;" class="fa fa-angle-double-right"></i> <strong>BA Performance by Unit (NOT SPECIFIC PRODUCTS)</strong></span>
								</div>
							</div>
						</div>
						<div class="body" style="background-color:#f1f1f1;padding-bottom:20px;">
							...
							<div style="margin-left:10px;margin-top:20px;margin-bottom:60px;background-color:transparent;padding:0px 20px;">
								<h2 style="color:#666;margin-left:10px;margin-bottom:0px;text-align:center;"><i class="fa fa-line-chart" style=""></i><i class="fa fa-close" style="margin-right:5px;font-size:12px;margin-left:-10px;margin-top:-4px;color:#fb654e;"></i>BA Performance by Unit (NOT SPECIFIC PRODUCTS)</h2>
									<p style="font-size:12px;color:#666;margin-left:10px;text-align:center;width:530px;margin:auto;margin-top:20px;">Module BA Performance by Unit (Reporting) merupakan salah satu module reporting, digunakan untuk mencetak dan mengeksport laporan performance dari BA dalam bentuk Qty / Unit yang terjual dengan kriteria tertentu.</p>
								...
								<div id="body">
									<?php 
										...
										$phpgrid->set_caption("<h4 style='color:#444;'><i class='fa fa-th-large' style='margin-right:5px;'></i>Pivot Table (BA Performance By Unit)</h4>");
										...
										$phpgrid->set_col_width('H1',70);
										$phpgrid->set_col_width('H2',70);
										$phpgrid->set_col_width('H3',70);
										$phpgrid->set_col_width('H4',70);
										$phpgrid->set_col_width('H5',70);
										$phpgrid->set_col_width('H6',70);
										$phpgrid->set_col_width('H7',70);
										$phpgrid->set_col_width('H8',70);
										$phpgrid->set_col_width('H9',70);
										$phpgrid->set_col_width('H10',70);
										$phpgrid->set_col_width('H11',70);
										$phpgrid->set_col_width('H12',70);
										$phpgrid->set_col_width('H13',70);
										$phpgrid->set_col_width('H14',70);
										$phpgrid->set_col_width('H15',70);
										$phpgrid->set_col_width('H16',70);
										$phpgrid->set_col_width('H17',70);
										$phpgrid->set_col_width('H18',70);
										$phpgrid->set_col_width('H19',70);
										$phpgrid->set_col_width('H20',70);
										$phpgrid->set_col_width('H21',70);
										$phpgrid->set_col_width('H22',70);
										$phpgrid->set_col_width('H23',70);
										$phpgrid->set_col_width('H24',70);
										$phpgrid->set_col_width('H25',70);
										$phpgrid->set_col_width('H26',70);
										$phpgrid->set_col_width('H27',70);
										$phpgrid->set_col_width('H28',70);
										$phpgrid->set_col_width('H29',70);
										$phpgrid->set_col_width('H30',70);
										$phpgrid->set_col_width('H31',70);
										
										
										
										
										$phpgrid->set_col_align("H1","center");
										$phpgrid->set_col_align("H2","center");
										$phpgrid->set_col_align("H3","center");
										$phpgrid->set_col_align("H4","center");
										$phpgrid->set_col_align("H5","center");
										$phpgrid->set_col_align("H6","center");
										$phpgrid->set_col_align("H7","center");
										$phpgrid->set_col_align("H8","center");
										$phpgrid->set_col_align("H9","center");
										$phpgrid->set_col_align("H10","center");
										$phpgrid->set_col_align("H11","center");
										$phpgrid->set_col_align("H12","center");
										$phpgrid->set_col_align("H13","center");
										$phpgrid->set_col_align("H14","center");
										$phpgrid->set_col_align("H15","center");
										$phpgrid->set_col_align("H16","center");
										$phpgrid->set_col_align("H17","center");
										$phpgrid->set_col_align("H18","center");
										$phpgrid->set_col_align("H19","center");
										$phpgrid->set_col_align("H20","center");
										$phpgrid->set_col_align("H21","center");
										$phpgrid->set_col_align("H22","center");
										$phpgrid->set_col_align("H23","center");
										$phpgrid->set_col_align("H24","center");
										$phpgrid->set_col_align("H25","center");
										$phpgrid->set_col_align("H26","center");
										$phpgrid->set_col_align("H27","center");
										$phpgrid->set_col_align("H28","center");
										$phpgrid->set_col_align("H29","center");
										$phpgrid->set_col_align("H30","center");
										$phpgrid->set_col_align("H31","center");
										...
										$phpgrid->set_col_align("TotalUnit","center");
