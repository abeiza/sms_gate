...
<head>
    ...
    <title>SMS GATEWAY | Panel Administration</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/production/css/maps/jquery-jvectormap-2.0.1.css" />
    <link href="<?php echo base_url(); ?>assets/production/css/icheck/flat/green.css" rel="stylesheet" />
    <link href="<?php echo base_url(); ?>assets/production/css/floatexamples.css" rel="stylesheet" type="text/css" />


    <!--<script src="<?php //echo base_url(); ?>assets/production/js/nprogress.js"></script>
    <script>
        NProgress.start();
    </script>-->
