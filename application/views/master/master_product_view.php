...
<div class="body" style="background-color:#f1f1f1;">
	<div>
		<div id="container">
			<?php echo form_open('master/master_product_controller/export_excel/');?>
				<div style="margin-bottom:10px;text-align:center;">
					<h2 style="color:#666;margin-left:10px;margin-bottom:0px;"><i class="fa fa-tags" style="margin-right:5px;"></i>Master Product</h2>
					<p style="font-size:12px;color:#666;margin-left:10px;">Module Master Product menampung data master Product sebagai acuan dalam pembuatan report (Laporan) yang berkaitan dengan sms gateway.</p>
