<?php
//* mysql example 
define('PHPGRID_DB_HOSTNAME', 'Driver={SQL Server};Server=192.168.171.6;Database=sms_live; Uid=sa;Pwd=G0C4dm1n;'); // database host name
define('PHPGRID_DB_USERNAME', 'sa');     // database user name
define('PHPGRID_DB_PASSWORD', 'G0C4dm1n'); // database password
define('PHPGRID_DB_NAME', 'sms_live'); // database name
...
define('SERVER_ROOT', '/phpGrid_sms');
