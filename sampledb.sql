...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2016 at 04:23 AM
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `isActive`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`) VALUES
(1002, 'Murphy', 'Diane', 1, 'x5800', 'dmurphy@classicmodelcars.com', '1', 0, 'President'),
(1056, 'Patterson', 'Mary', 1, 'x4611', 'mpatterso@classicmodelcars.com', '1', 1002, 'VP Sales'),
(1076, 'Firrelli', 'Jeff', 1, 'x9273', 'jfirrelli@classicmodelcars.com', '1', 1002, 'VP Marketing'),
(1088, 'Patterson', 'William', 1, 'x4871', 'wpatterson@classicmodelcars.com', '6', 1056, 'Sales Manager (APAC)'),
(1102, 'Bondur', 'Gerard', 1, 'x5408', 'gbondur@classicmodelcars.com', '4', 1056, 'Sale Manager (EMEA)'),
(1143, 'Bow', 'Anthony', 1, 'x5428', 'abow@classicmodelcars.com', '1', 1056, 'Sales Manager (NA)'),
(1165, 'Jennings', 'Leslie', 0, 'x3291', 'ljennings@classicmodelcars.com', '4', 1143, 'Sales Rep'),
(1166, 'Thompson', 'Leslie', 1, 'x4065', 'lthompson@classicmodelcars.com', '1', 1143, 'Sales Rep'),
(1188, 'Firrelli', 'Julie', 1, 'x2173', 'jfirrelli@classicmodelcars.com', '2', 1143, 'Sales Rep'),
...
(1370, 'Hernandez', 'Gerard', 1, 'x2028', 'ghernande@classicmodelcars.com', '4', 1102, 'Sales Rep'),
(1401, 'Castillo', 'Pamela', 1, 'x2759', 'pcastillo@classicmodelcars.com', '7', 1102, 'Sales Rep'),
(1501, 'Bott', 'Larry', 1, 'x2311', 'lbott@classicmodelcars.com', '7', 1102, 'Sales Rep'),
...
INSERT INTO `joborders` (`jobNumber`, `jobDescription`, `status`, `percentComplete`, `isClosed`) VALUES
(1, 'process order #1', 'In-progress', 23, 0),
(2, 'process order #2', 'In-progress', 34, 0),
(3, 'process order #3', 'In-progress', 45, 0),
(4, 'process order #4', 'In-progress', 12, 0),
(5, 'process order #5', 'In-progress', 4, 0),
...
`orderNumber` int(11) NOT NULL,
  ...
  `comments` text,
  `customerNumber` int(11) NOT NULL,
  `contractDateTime` datetime DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11004 ;

--
-- Dumping data for table `orders`
--

INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`, `contractDateTime`) VALUES
(0, '2010-08-20', '2010-08-20', NULL, 'Open', 'foo', 123456, NULL),
(10100, '2003-01-06', '2003-11-13', '2003-01-10', 'Shipped', 'foo', 363, NULL),
(10101, '2003-01-18', '2003-01-31', '2003-01-22', 'Shipped', 'Check on availability.', 128, NULL),
(10102, '2003-01-10', '1918-11-23', '1946-04-10', 'Shipped', '', 181, NULL),
(10103, '2003-01-29', '2003-02-19', '2003-02-02', 'Shipped', 'fasdfasdfa asdfa', 141, NULL),
(10104, '2003-01-25', '2003-02-09', '2003-04-24', 'Shipped', '', 141, NULL),
(10105, '2003-02-11', '2003-02-21', '2003-02-12', 'Shipped', NULL, 145, NULL),
(10106, '2003-02-17', '2003-02-24', '2003-02-21', 'Shipped', 'Foobar using XML as datasource', 278, NULL),
...
(10108, '2003-03-03', '2003-03-12', '2008-03-12', 'Shipped', 'test', 385, NULL),
...
('Vintage Cars', 'Our Vintage Car models realistically portray automobiles produced from the early 1900s through the 1940s. Materials used include Bakelite, diecast, plastic and wood. Most of the replicas are in the 1:18 and 1:24 scale sizes, which provide the optimum in detail and accuracy. Prices range from $30.00 up to $180.00 for some special limited edition replicas. All models include a certificate of authenticity from their manufacturers and come fully assembled and ready for display in the home or office.', NULL, 0x70687047726964782f53616d706c65496d616765732f70686f746f732f76696e746167655f6361722e6a7067),
('Ships', 'The perfect holiday or anniversary gift for executives, clients, friends, and family. These handcrafted model ships are unique, stunning works of art that will be treasured for generations! They come fully assembled and ready for display in the home or office. We guarantee the highest quality, and best value.', NULL, 0x70687047726964782f53616d706c65496d616765732f70686f746f732f736869702e676966),
('Trains', 'Model trains are a rewarding hobby for enthusiasts of all ages. Whether you''re looking for collectible wooden trains, electric streetcars or locomotives, you''ll find a number of great choices for any budget within this category. The interactive aspect of trains makes toy trains perfect for young children. The wooden train sets are ideal for children under the age of 5.', NULL, 0x70687047726964782f53616d706c65496d616765732f70686f746f732f747261696e2e6a7067),
('Planes', 'Unique, diecast airplane and helicopter replicas suitable for collections, as well as home, office or classroom decorations. Models contain stunning details such as official logos and insignias, rotating jet engines and propellers, retractable wheels, and so on. Most come fully assembled and with a certificate of authenticity from their manufacturers.', NULL, 0x70687047726964782f53616d706c65496d616765732f70686f746f732f616972706c616e652e6a7067),
('Motorcycles', 'Our motorcycles are state of the art replicas of classic as well as contemporary motorcycle legends such as Harley Davidson, Ducati and Vespa. Models contain stunning details such as official logos, rotating wheels, working kickstand, front suspension, gear-shift lever, footbrake lever, and drive chain. Materials used include diecast and plastic. The models range in size from 1:10 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. All models come fully assembled and ready for display in the home or office. Most include a certificate of authenticity.', NULL, 0x70687047726964782f53616d706c65496d616765732f70686f746f732f6d6f746f726379636c652e6a7067),
('Classic Cars', 'Attention car enthusiasts: Make your wildest car ownership dreams come true. Whether you are looking for classic muscle cars, dream sports cars or movie-inspired miniatures, you will find great choices in this category. These replicas feature superb attention to detail and craftsmanship and offer features such as working steering system, opening forward compartment, opening rear trunk with removable spare wheel, 4-wheel independent spring suspension, and so on. The models range in size from 1:10 to 1:24 scale and include numerous limited edition and several out-of-production vehicles. All models include a certificate of authenticity from their manufacturers and come fully assembled and ready for display in the home or office.', NULL, 0x70687047726964782f53616d706c65496d616765732f70686f746f732f636c61737369635f6361722e6a7067),
('Trucks and Buses', 'The Truck and Bus models are realistic replicas of buses and specialized trucks produced from the early 1920s to present. The models range in size from 1:12 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. Materials used include tin, diecast and plastic. All models include a certificate of authenticity from their manufacturers and are a perfect ornament for the home and office.', NULL, 0x70687047726964782f53616d706c65496d616765732f70686f746f732f747275636b2e6a7067);
...
INSERT INTO `productparts` (`partNo`, `partName`, `productCode`) VALUES
...
INSERT INTO `shippers` (`ShipperID`, `CompanyName`, `Phone`, `fileToUpload`) VALUES
(1, 'Speedy Esd', '(503) 555-983123', 'IMAG0456.jpg'),
(2, 'United Package', '34324', 'xyz.jpg'),
(3, 'Federal Shipping', '(503) 555-99313', 'IMAG0489.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `supplierproductlines`
--

CREATE TABLE IF NOT EXISTS `supplierproductlines` (
`productLineNo` int(15) NOT NULL,
...
--
-- Dumping data for table `supplierproductlines`
--

INSERT INTO `supplierproductlines` (`productLineNo`, `productLine`, `supplierCode`, `supplierName`) VALUES
...
(11, 'Vintage Cars', 3, 'Highway 66 Mini Classics'),
...
(53, 'Trucks and Buses', 11, 'Exoto Designs'),
...
INSERT INTO `suppliers` (`supplierCode`, `supplierName`, `supplierAddress`, `supplierState`, `supplierZip`, `supplierPhoneNumber`) VALUES
...
(3, 'Highway 66 Mini Classics', '1543W Main St Alhambra', 'CA', '91801-1949', '626-289-8000'),
...
(7, 'Autoart Studio Design', '1125 W Main St Alhambra', 'CA', '91801-3328', '626-293-7388'),
...
--
-- Indexes for table `supplierproductlines`
--
ALTER TABLE `supplierproductlines`
 ADD PRIMARY KEY (`productLineNo`);
...
--
ALTER TABLE `joborders`
MODIFY `jobNumber` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
MODIFY `orderNumber` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11004;
--
-- AUTO_INCREMENT for table `productparts`
--
ALTER TABLE `productparts`
MODIFY `partNo` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
--
...
--
-- AUTO_INCREMENT for table `supplierproductlines`
--
ALTER TABLE `supplierproductlines`
MODIFY `productLineNo` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=66;
--
-- AUTO_INCREMENT for table `suppliers`
--
ALTER TABLE `suppliers`
MODIFY `supplierCode` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
